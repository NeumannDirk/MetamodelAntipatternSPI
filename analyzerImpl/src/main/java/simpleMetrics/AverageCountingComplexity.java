...
public class AverageCountingComplexity extends AbstractMetric {

	private static final String name = "AverageCountingComplexity";
	private static final String shortcut = "ACC";
	...
	public AverageCountingComplexity() {
	...
	public Double evaluate(Resource resource) {
		...
		return countingComplexity / eClasses.size();
	}
}